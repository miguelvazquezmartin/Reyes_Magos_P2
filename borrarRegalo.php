                ...
                <div class="col-lg-6 col-md-8">
                    <div class="card">
                        <div class="card-body text-center">
                            <h3 class="card-title text-center">Introduce el id del regalo que desea quitar</h3>
                            <form action="borrarRegalo.php" method="POST">
                                <div class="row">
                                    <div class="col-12 py-3">
                                        <label>Número id del regalo</label>
                                        <input type="number" id="idRegalo" name="idRegalo" min="1" required>
                                    </div>
                                    <div class="col-12 py-3">
